...
function changeAddressTmp() {
  ...
  var addressId = checked.querySelector('.userInfoIdSelect').getAttribute('value')
...
var quanHuyenData = {
  ...
  'Hà Nam': ['Phủ Lý', 'Thị xã Duy Tiên', 'Huyện Kim Bảng', 'Huyện Thanh Liêm', 'Huyện Bình Lục', 'Huyện Lý Nhân'],
  'Nam Định': [
    'Nam Định',
    'Huyện Mỹ Lộc',
    'Huyện Vụ Bản',
...
var phuongXaData = {
  ...
  'Thị xã Quảng Trị': ['Phường 1', 'Phường An Đôn', 'Phường 2', 'Phường 3', 'Xã Hải Lệ'],
  'Huyện Vĩnh Linh': [
    'Thị trấn Hồ Xá',
    'Thị trấn Bến Quan',
    'Xã Vĩnh Thái',
  ...
  'Huyện Minh Long': ['Xã Long Sơn', 'Xã Long Mai', 'Xã Thanh An', 'Xã Long Môn', 'Xã Long Hiệp'],
  'Huyện Nghĩa Hành': [
    'Thị trấn Chợ Chùa',
    'Xã Hành Thuận',
    'Xã Hành Dũng',
  ...
  'Huyện Thuận Bắc': ['Xã Phước Chiến', 'Xã Công Hải', 'Xã Phước Kháng', 'Xã Lợi Hải', 'Xã Bắc Sơn', 'Xã Bắc Phong'],
  'Huyện Thuận Nam': [
    'Xã Phước Hà',
    'Xã Phước Nam',
    'Xã Phước Ninh',
...
$(document).ready(function () {
  $('.promoBtn').click(function (e) {
    ...
    if (inputPromo.value.trim() == '') {
      showPromoMessage('Nếu bạn muốn áp dụng mã khuyến mãi, vui lòng điền mã vào', true)
      return
    }
    ...
    $.ajax({
      ...
      if (data.success && isValidDateApply(data)) {
        ...
        if (data.success && !isValidDateApply(data)) {
          showPromoMessage('Mã khuyến mãi chưa đến hạn sử dụng hoặc đã hết hạn', true)
        } else {
  ...
  $(document).ready(function () {
    $.ajax({
      ...
      if (loadAddressForTheFirstTime) {
        document.querySelector('.cancel.change_address').addEventListener('click', (e) => {
          popupToggle(`changeAddressMenu`)
          popupToggle(`addressMenu`)
          document.querySelector('.confirm.change_address').classList.remove('hidden')
          document.querySelector('.confirm.create_address').classList.add('hidden')
...
function renderUserInfoHTML(data) {
  ...
  data.forEach((address, index) => {
    ...
    const html = `<label class="address-select">
                    ...
                    <span class="sdt">(+84) ${address.phone_number.slice(1)}</span>
...
function validFormUpdateUserInfoAddress() {
  ...
  const isValidAll =
    isValidFullName && isValidPhoneNumber && isValidCity && isValidDistrict && isValidWard && isValidAddress
...
$(document).ready(function () {
  $('.xacNhanThanhToan').click(function (e) {
    ...
    // console.log(document.querySelector('#diachi'))
    ...
    $.ajax({
      ...
      if (data.successEnoughAll != undefined && !data.successEnoughAll) {
        ...
        document.querySelector('.modalNotEnoughQuantity-container').classList.remove('hide')
